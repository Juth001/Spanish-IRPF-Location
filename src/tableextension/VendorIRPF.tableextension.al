...
tableextension 86322 "Vendor_IRPF" extends Vendor
{
    fields
    {
        field(60500; "Importe Ret. Alquileres"; Decimal)
        {
            ...
            CalcFormula = Sum("IND Witholding Tax registers"."Importe retención" WHERE("Cli/Prov" = CONST(Proveedor), "Nº Proveedor / Nº Cliente" = FIELD("No."), "Tipo Retención" = CONST(Alquiler)));
        ...
        {
            FieldClass = FlowField;
            CalcFormula = Sum("IND Witholding Tax registers"."Importe retención" WHERE("Cli/Prov" = CONST(Proveedor), "Nº Proveedor / Nº Cliente" = FIELD("No."), "Tipo Retención" = CONST(Garantía)));
        ...
        {
            FieldClass = FlowField;
            CalcFormula = Sum("IND Witholding Tax registers"."Importe retención" WHERE("Cli/Prov" = CONST(Proveedor), "Nº Proveedor / Nº Cliente" = FIELD("No."), "Tipo Retención" = CONST(Profesionales)));
        ...
        {
            FieldClass = FlowField;
            CalcFormula = Sum("IND Witholding Tax registers"."Importe retención" WHERE("Cli/Prov" = CONST(Proveedor), "Nº Proveedor / Nº Cliente" = FIELD("No."), "Tipo Retención" = CONST(Otros)));
