...
//                         {
//                             //}
//                             //TODO:column(Origen; Origen)
//                             //{
//                             // }
//                             //TODO: column(Destino; Destino)
//                             //{
//                         }
...
//                     if not CurrReport.Preview then SegManagement.LogDocument(14, "No.", 0, 0, Database::Vendor, "Buy-from Vendor No.", "Purchaser Code", '', "Posting Description", '');
...
//                 clear(TextoSII);
//                 if EsFPC then
//                     if COMPANYNAME <> 'CGL_PORTUGAL' then TextoSII := StrSubstNo(TextSII50001, "Document Date", "Transaction Date");
//                 //<B59 003 00000000B59 MDS 2017.08.03
//             end;
//         }
//     }
...
//                 end
//                 else
//                     if (PorcientoIVA2 = VATAmountLine."VAT %") and (PorcientoIVA2 <> 0) then begin
//                         //Se lo sumo al IVA2
//                         Base2 += VATAmountLine."VAT Base";
//                         CuotaIVA2 += VATAmountLine."VAT Amount";
//                     end
//                     else
//                         if (PorcientoIVA3 = VATAmountLine."VAT %") and (PorcientoIVA3 <> 0) then begin
//                             //Se lo sumo al IVA3
...
//                                 if (VATAmountLine."VAT Calculation Type" = VATAmountLine."vat calculation type"::"No taxable VAT") and (VATAmountLine."VAT Identifier" = 'NO SUJETO') and (PorcientoIVA1 = 0) then
//                                     Base1 := 0;
...
//                                 CuotaIVA2 := VATAmountLine."VAT Amount";
//                                 //Para deducir de la base los importes de las retenciones (NO SUJETO)
//                                 if (VATAmountLine."VAT Calculation Type" = VATAmountLine."vat calculation type"::"No taxable VAT") and (VATAmountLine."VAT Identifier" = 'NO SUJETO') and (PorcientoIVA2 = 0) then
//                                     Base2 := 0;
...
//                                 CuotaIVA3 := VATAmountLine."VAT Amount";
//                                 //Para deducir de la base los importes de las retenciones (NO SUJETO)
//                                 if (VATAmountLine."VAT Calculation Type" = VATAmountLine."vat calculation type"::"No taxable VAT") and (VATAmountLine."VAT Identifier" = 'NO SUJETO') and (PorcientoIVA3 = 0) then
//                                     Base3 := 0;
